...
const Carusel = () => {
    return (
        <Carousel showThumbs={false} autoPlay infiniteLoop>
            ...
            <div className='text-start py-20 md:py-40 bg-cover bg-center  px-5 md:px-20 text-white space-y-2 md:space-y-8' style={{ backgroundImage: "url('/s3.jpg')" }} >
            ...
            <div className=' text-start py-20 md:py-40 bg-cover bg-center  px-5 md:px-20 text-white space-y-2 md:space-y-8' style={{ backgroundImage: "url('/s2.jpg')" }} >
