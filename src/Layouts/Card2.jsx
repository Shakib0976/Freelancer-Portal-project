    ...
    return (
        <div className='w-11/12 mx-auto  '>
            <div className='grid md:grid-cols-2  lg:grid-cols-3 my-40 gap-5 space-x-5'>
                <div className='p-4 border-1 border-gray-400 rounded-2xl  h-50  mx-auto shadow-xl'>
                    <h1 className='text-5xl font-semibold text-green-800  mb-4'>3 million</h1>
                    <p className='text-xl '>rated freelancers, covering 8,766 skills and create projects complete</p>
                </div>
